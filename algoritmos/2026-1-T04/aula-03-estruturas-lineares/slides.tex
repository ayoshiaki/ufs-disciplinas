...
\begin{frame}[shrink]{Listas Duplamente Ligadas: Estrutura}
...
\begin{frame}[fragile,shrink]{Lista Duplamente Ligada: Remoção}
...
\begin{frame}[fragile,shrink]{Lista Duplamente Ligada: Inserção}
...
\begin{frame}[shrink]{Recapitulação: O que Aprendemos Hoje}
    \centering
    \renewcommand{\arraystretch}{1.3}
    \small
