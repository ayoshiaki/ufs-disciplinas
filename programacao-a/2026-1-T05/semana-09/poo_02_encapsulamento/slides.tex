...
\begin{frame}[fragile,shrink]{\texttt{\_\_str\_\_} vs \texttt{\_\_repr\_\_}}
\begin{lstlisting}
class Lanche:
    def __init__(self, nome, preco):
        self._nome = nome
...
\begin{frame}[fragile,shrink]{Classe \texttt{Fracao}: construtor e simplificação}
\begin{lstlisting}
...
\begin{frame}[fragile,shrink]{Classe \texttt{Fracao}: operações aritméticas}
\begin{lstlisting}
