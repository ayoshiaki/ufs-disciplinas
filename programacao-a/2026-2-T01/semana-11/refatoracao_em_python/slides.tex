...
\begin{frame}[fragile,shrink=5]{Long Method (Método Longo)}
...
\begin{frame}[shrink]{Quatro refatorações que cobrem 80\% dos casos}
  \begin{center}
  \begin{tikzpicture}[
...
\begin{frame}[shrink=5]{O ciclo Red--Green--Refactor}
  \begin{center}
  \begin{tikzpicture}[
...
\begin{frame}[fragile,shrink=5]{Parametrização e exceções}
\begin{lstlisting}
import pytest
...
\begin{frame}[fragile,shrink=5]{Antes e depois da PEP 8}
