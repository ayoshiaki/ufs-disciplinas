...
% SLIDE 13
% ============================================================
\begin{frame}[fragile,shrink]{Métodos: Adicionando Comportamento}
  \begin{lstlisting}[language=Python]
class Lanche:
    def __init__(self, nome, preco, ingredientes):
        self.nome = nome
...
% SLIDE 16
% ============================================================
\begin{frame}[fragile,shrink]{Exemplo: Atributo de Classe}
  \begin{lstlisting}[language=Python]
class Lanche:
...
% SLIDE 17
% ============================================================
\begin{frame}[fragile,shrink]{Armadilha: Atributo de Classe Mutável}
  \begin{lstlisting}[language=Python]
class Lanche:
...
% SLIDE 18
% ============================================================
\begin{frame}[fragile,shrink]{Correção: Criar Mutáveis no \texttt{\_\_init\_\_}}
  \begin{lstlisting}[language=Python]
class Lanche:
    def __init__(self, nome):
        self.nome = nome
...
% SLIDE 20
% ============================================================
\begin{frame}[fragile,shrink]{Classe \texttt{Cardapio}: Estrutura}
  \begin{lstlisting}[language=Python]
class Cardapio:
...
% SLIDE 22
% ============================================================
\begin{frame}[fragile,shrink]{Usando o Cardápio}
  \begin{lstlisting}[language=Python]
